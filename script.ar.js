    ...
    for (const item of gridItems){
        item.addEventListener("click",function () 
        {
            ...
            if(boardArray[index] == "X" || boardArray[index] == "O"){
                document.getElementById("instructions").innerText = "! تم اللعب هنا من قبل"
                return 
            }
            ...
            document.getElementById("instructions").textContent = `${currentTurn} إنه دور`
            ...
            function evaluteBoard(){
                if(
                    ...
                    gameIsFinished = true
                    document.getElementById("instruction").innerHTML = `<p>.${currentTurn} لقد فاز <br> <span>اضغظ على زر إعادة اللعبة للإكمال</span></p>`
                    setTimeout(() => {
                ...
                if(isDraw){
                    gameIsFinished = true
                    document.getElementById("instruction").innerHTML = "<p>!يبدوا أنه تعادل<br> <span>اضغظ على زر إعادة اللعبة للإكمال</span></p>"
                    setTimeout(() => {
                        document.getElementById("instruction").innerHTML = " "
                    }, 3000);
                }
...
function reset() {
    ...
    currentTurn = "X"
    document.getElementById("instructions").innerText = "! ابدء اللعبة"
    // reset visual part
